---
title: "Introduction to VETravelDemandWFH"
author: "Liming Wang"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to VETravelDemandWFH}
...
The VETravelDemandWFH module is a R package that implements a module for [the VisionEval framework](https://gregorbj.github.io/VisionEval/) to simulate multi-modal travel demand for individual households including:
...
```{r, eval=FALSE}
devtools::install_github("gregorbj/VisionEval/sources/modules/VETravelDemandWFH@develop")
# OR
devtools::install_github("cities-lab/VETravelDemandWFH")
```
...
The source code of the VETravelDemandWFH package is available on github: https://github.com/cities-lab/VETravelDemandWFH 
...
The automated tests are handled by [Travis-CI](https://travis-ci.org/) and the current status of automated tests for the package is [![Travis-CI Build Status](https://travis-ci.org/cities-lab/VETravelDemandWFH.svg)](https://travis-ci.org/cities-lab/VETravelDemandWFH).
