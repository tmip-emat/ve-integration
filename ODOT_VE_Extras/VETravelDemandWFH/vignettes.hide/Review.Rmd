---
title: "VETravelDemandWFH Module Contribution Review"
author: "Liming Wang"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{VETravelDemandWFH Module Contribution Review}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

This vignette documents responses to [VisionEval Contribution Review Criteria](https://github.com/gregorbj/VisionEval/wiki/Contribution-Review-Criteria) for the VETravelDemandWFH module.
...
The tests running all 6 models in the module using Rogue Valley data take between 1 minute to 1 minutes and 30 seconds across different builds on Travis CI (See https://travis-ci.org/cities-lab/VETravelDemandWFH/builds), on average 10 - 15 seconds per model, which is almost the same as the GreenSTEP/RSPM VETravelDemand module (https://travis-ci.org/gregorbj/VisionEval/builds).
...
Automated tests including `devtools.check()`, installation testing, and test runs of models in the module with `visioneval::testModule()` are in place with [Travis-CI](https://travis-ci.org/cities-lab/VETravelDemandWFH). All tests pass in the current and recent builds.
