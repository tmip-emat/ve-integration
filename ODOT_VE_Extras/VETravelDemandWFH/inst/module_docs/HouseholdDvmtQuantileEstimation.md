...
Residuals:
      Min        1Q    Median        3Q       Max 
-0.204970 -0.012127  0.000504  0.012417  0.213047 

Coefficients:
              Estimate Std. Error t value Pr(>|t|)    
(Intercept)  1.215e+00  1.926e-03   630.6   <2e-16 ***
Drivers      9.831e-02  2.531e-04   388.4   <2e-16 ***
LogIncome    1.280e+00  3.586e-03   356.9   <2e-16 ***
Hbppopdn    -1.382e-05  3.033e-08  -455.8   <2e-16 ***
NumVeh       2.993e-02  1.947e-04   153.7   <2e-16 ***
ZeroVeh     -3.211e-01  8.283e-04  -387.6   <2e-16 ***
OneVeh      -6.242e-02  3.995e-04  -156.2   <2e-16 ***
Workers      7.002e-02  1.778e-04   393.9   <2e-16 ***
Age0to14     6.052e-02  1.387e-04   436.3   <2e-16 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

Residual standard error: 0.02264 on 35494 degrees of freedom
Multiple R-squared:  0.9924,	Adjusted R-squared:  0.9924 
F-statistic: 5.776e+05 on 8 and 35494 DF,  p-value: < 2.2e-16
...
|Simulated Average DVMT | 55.46790|
|Predicted Average DVMT | 55.53158|
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.20233 -0.01805  0.00027  0.01755  0.32181 

Coefficients:
               Estimate Std. Error t value Pr(>|t|)    
(Intercept)   1.104e+00  4.330e-03  255.01   <2e-16 ***
Drivers       1.196e-01  5.468e-04  218.72   <2e-16 ***
LogIncome     2.007e+00  7.511e-03  267.26   <2e-16 ***
Hbppopdn     -1.156e-05  4.448e-08 -259.93   <2e-16 ***
NumVeh        3.029e-02  4.948e-04   61.22   <2e-16 ***
ZeroVeh      -5.889e-01  1.591e-03 -370.13   <2e-16 ***
OneVeh       -8.735e-02  9.143e-04  -95.53   <2e-16 ***
Workers       1.265e-01  3.898e-04  324.61   <2e-16 ***
UrbanDev     -6.398e-02  8.049e-04  -79.50   <2e-16 ***
Age0to14      7.748e-02  2.957e-04  262.04   <2e-16 ***
BusEqRevMiPC -3.622e-04  1.035e-05  -34.99   <2e-16 ***
FwyLaneMiPC   6.438e+01  1.713e+00   37.57   <2e-16 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

Residual standard error: 0.03651 on 19619 degrees of freedom
Multiple R-squared:  0.9941,	Adjusted R-squared:  0.9941 
F-statistic: 3.029e+05 on 11 and 19619 DF,  p-value: < 2.2e-16
...
|Simulated Average DVMT | 53.49150|
|Predicted Average DVMT | 53.61335|
...
Residuals:
    Min      1Q  Median      3Q     Max 
-33.257  -4.157  -0.036   4.079  68.258 

Coefficients:
              Estimate Std. Error t value Pr(>|t|)    
(Intercept)  2.305e+01  1.182e-01  195.02   <2e-16 ***
Dvmt         2.716e+00  3.699e-03  734.12   <2e-16 ***
DvmtSq      -2.395e-03  2.919e-05  -82.06   <2e-16 ***
DvmtCu       1.737e-06  3.007e-08   57.76   <2e-16 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

Residual standard error: 6.731 on 35499 degrees of freedom
Multiple R-squared:  0.9909,	Adjusted R-squared:  0.9909 
F-statistic: 1.291e+06 on 3 and 35499 DF,  p-value: < 2.2e-16
...
Residuals:
    Min      1Q  Median      3Q     Max 
-53.160  -3.947  -0.014   3.883  39.960 

Coefficients:
              Estimate Std. Error t value Pr(>|t|)    
(Intercept)  1.559e+01  1.524e-01  102.30   <2e-16 ***
Dvmt         2.999e+00  7.386e-03  406.10   <2e-16 ***
DvmtSq      -8.066e-03  9.965e-05  -80.94   <2e-16 ***
DvmtCu       1.965e-05  3.705e-07   53.03   <2e-16 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

Residual standard error: 6.533 on 19627 degrees of freedom
Multiple R-squared:  0.9921,	Adjusted R-squared:  0.9921 
F-statistic: 8.205e+05 on 3 and 19627 DF,  p-value: < 2.2e-16
