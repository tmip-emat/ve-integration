...
|Beta    |double    |multiplier |<= 0, > 10 |                                                                               |         |The power value to be used in the exponential function to adjusts the operations effectiveness for driverless vehicles. |
### av_lev5_effectiveness.csv
|   |NAME       |TYPE      |UNITS      |PROHIBIT |ISELEMENTOF              |UNLIKELY |DESCRIPTION                                                                                                                                   |
|:--|:----------|:---------|:----------|:--------|:------------------------|:--------|:---------------------------------------------------------------------------------------------------------------------------------------------|
|3  |Level      |character |category   |         |None, Mod, Hvy, Sev, Ext |         |Congestion levels: None = none, Mod = moderate, Hvy = heavy, Sev = severe, Ext = extreme                                                      |
|4  |Art_Rcr    |double    |percentage |         |                         |         |Percentage reduction of recurring arterial delay that would occur with full deployment of other user-defined arterial operations measures     |
|5  |Art_NonRcr |double    |percentage |         |                         |         |Percentage reduction of non-recurring arterial delay that would occur with full deployment of other user-defined arterial operations measures |
|6  |Fwy_Rcr    |double    |percentage |         |                         |         |Percentage reduction of recurring freeway delay that would occur with full deployment of other user-defined freeway operations measures       |
|7  |Fwy_NonRcr |double    |percentage |         |                         |         |Percentage reduction of non-recurring freeway delay that would occur with full deployment of other user-defined freeway operations measures   |
### marea_av_capacity_factors.csv
|   |NAME                  |TYPE      |UNITS      |PROHIBIT     |ISELEMENTOF |UNLIKELY |DESCRIPTION                                                                                         |
|:--|:---------------------|:---------|:----------|:------------|:-----------|:--------|:---------------------------------------------------------------------------------------------------|
|8  |Marea                 |character |ID         |             |            |         |Marea as defined in geo.csv file                                                                    |
|9  |MPR                   |double    |proportion |NA, < 0, > 1 |            |         |Market penetration of AV level 3 and 5 by marea                                                     |
|10 |FwyCapacityMultiplier |double    |multiplier |NA, < 0      |            |         |Multiplier to adjust the freeway capacity based on market penetration of AV level 3 and 5 vehicles  |
|11 |ArtCapacityMultiplier |double    |multiplier |NA, < 0      |            |         |Multiplier to adjust the arterial capacity based on market penetration of AV level 3 and 5 vehicles |
...
|AVLvl5Share             |Marea                |Year   |double    |porportion |< 0, > 1     |                                                                               |
|AVLvl3Share             |Marea                |Year   |double    |porportion |< 0, > 1     |                                                                               |
|Marea                   |AVCapacityFactors    |Global |character |ID         |             |                                                                               |
|MPR                     |AVCapacityFactors    |Global |double    |proportion |NA, < 0, > 1 |                                                                               |
|FwyCapacityMultiplier   |AVCapacityFactors    |Global |double    |multiplier |NA, < 0      |                                                                               |
|ArtCapacityMultiplier   |AVCapacityFactors    |Global |double    |multiplier |NA, < 0      |                                                                               |
...
|Level                   |AVLev5Effectiveness  |Global |character |category   |             |None, Mod, Hvy, Sev, Ext                                                       |
|Art_Rcr                 |AVLev5Effectiveness  |Global |double    |proportion |             |                                                                               |
|Art_NonRcr              |AVLev5Effectiveness  |Global |double    |proportion |             |                                                                               |
|Fwy_Rcr                 |AVLev5Effectiveness  |Global |double    |proportion |             |                                                                               |
|Fwy_NonRcr              |AVLev5Effectiveness  |Global |double    |proportion |             |                                                                               |
