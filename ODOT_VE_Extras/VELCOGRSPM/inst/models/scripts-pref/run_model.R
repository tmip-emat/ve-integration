...
for(Year in getYears()) {
  ...
  runModule("CalculateCarbonIntensity",        "VEPowertrainsAndFuelsSTS", RunFor = "AllYears",    RunYear = Year)
  runModule("AssignHhVehiclePowertrain",       "VEPowertrainsAndFuelsSTS", RunFor = "AllYears",    RunYear = Year)
  for (i in 1:2) {
